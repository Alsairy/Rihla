...
export const TripSchedulingDashboard: React.FC<TripSchedulingDashboardProps> = ({
  ...
  const loadDailySchedule = async () => {
    try {
      ...
      const response = await apiClient.get(`/api/trips/daily-schedule?date=${dateStr}`);
              ...
              <Grid size={{ xs: 12, md: 3 }}>
                <Card>
                  <CardContent sx={{ textAlign: 'center' }}>
                    ...
                    <Typography variant="h4">{schedule.scheduledTrips.length}</Typography>
                    <Typography variant="body2" color="textSecondary">
                      Scheduled Trips
                    </Typography>
                  </CardContent>
              ...
              <Grid size={{ xs: 12, md: 3 }}>
                <Card>
                  <CardContent sx={{ textAlign: 'center' }}>
                    ...
                    <Typography variant="h4">{schedule.unscheduledRoutes.length}</Typography>
                    <Typography variant="body2" color="textSecondary">
                      Unscheduled Routes
                    </Typography>
                  </CardContent>
              ...
              <Grid size={{ xs: 12, md: 3 }}>
                <Card>
                  <CardContent sx={{ textAlign: 'center' }}>
                    ...
                    <Typography variant="h4">{schedule.conflicts.length}</Typography>
                    <Typography variant="body2" color="textSecondary">
                      Conflicts
                    </Typography>
                  </CardContent>
                        ...
                        <TableRow key={trip.id}>
                          ...
                          <TableCell>
                            <Chip
                              label={trip.type}
                              size="small"
                              color={trip.type === 'PickUp' ? 'primary' : 'secondary'}
                            />
                          </TableCell>
                          <TableCell>{formatTime(trip.scheduledStartTime)}</TableCell>
                          <TableCell>{formatTime(trip.scheduledEndTime)}</TableCell>
                          <TableCell>
                            <Chip
                              label={trip.status}
                              size="small"
