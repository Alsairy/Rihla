    ...
    <Box sx={{ height, width: '100%', borderRadius: 1, overflow: 'hidden' }}>
      ...
      >
            ...
            >
              <Popup>
                <Box sx={{ minWidth: 200 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    <strong>Driver:</strong> {vehicle.driverName || 'Not assigned'}
                  </Typography>
                  <Box sx={{ mt: 1 }}>
                    <Chip 
        ...
        {showStudents && students.map((student) => {
          if (!student.pickupLatitude || !student.pickupLongitude) return null;
            ...
            >
              <Popup>
                <Box sx={{ minWidth: 150 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    <strong>Pickup:</strong> {student.pickupAddress || 'Address not set'}
                  </Typography>
                  {student.routeId && (
                    <Typography variant="body2" color="text.secondary">
